...
int main(void) {
  ...
  for (int i = 0; i < numIterations; i++) {
    ...
    double x = randDouble();  //QUESTION: if you use srand(42) with same seed 42 every time, won't it give you the same random number (first one out of the seed's "list")? then how would there be a ratio?
